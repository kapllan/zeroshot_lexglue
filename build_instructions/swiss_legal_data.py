...
if __name__ == '__main__':
    ...
    for config_name in configs:
        ...
        label_names = dataset['train'].features['label'].names+validation_dataset.features['label'].names+dataset['test'].features['label'].names
                ...
                for threshold in [4000, 3800, 3600, 3400, 3200, 3000, 2800, 2600, 2400, 2000]:
                    ...
                    if templated_text_length + input_text_length <= 3900:
                        ...
                        file.write(json.dumps(
                            {'input_text': text_input, 'language': language, 'answer': answer},
                            ensure_ascii=False) + '\n')
